    ...
    <div className="app-shell">
      ...
      <main className="dashboard-main">
        ...
        <motion.section className="dashboard-grid" initial="hidden" animate="visible" variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.06 } } }}>
          <motion.div className="overview-column overview-column-focused" variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }}><div className="overview-brief"><span className="eyebrow">Overview / daily status</span><p>Use the navigation rail for nutrition, progress, rewards, and training protocols.</p></div><VitalStrip /><DailyStreak /></motion.div>
