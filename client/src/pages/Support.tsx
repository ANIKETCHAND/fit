...
export default function Support() {
  ...
  return <WorkflowLayout kicker="Support" title="Keep the signal moving" detail="Find concise answers, route to the right workflow, or package a diagnostic trace for the FitTrack support team.">
